/* global React */
// ============================================================
// Icon — inline SVG (Lucide-style, stroke 1.8) so it survives
// React re-renders without needing lucide.createIcons().
// ============================================================
const ICON_PATHS = {
  ...
  euro: '<path d="M14.5 4.5a6 6 0 1 0 0 15M5 9.5h7M5 14.5h6"/>',
  ...
  "graduation-cap": '<path d="M22 10 12 5 2 10l10 5 10-5z"/><path d="M6 12v5c0 1 2.5 3 6 3s6-2 6-3v-5"/>',
  ...
  quote: '<path d="M3 21c3 0 7-1 7-8V5c0-1.25-.75-2-2-2H4c-1.25 0-2 .75-2 2v4c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z"/><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.75-2-2-2h-4c-1.25 0-2 .75-2 2v4c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z"/>',
  ...
  sprout: '<path d="M7 20h10M12 20v-8M12 12C12 7 8 5 4 5c0 4 3 7 8 7zM12 12c0-3 2-5 5-5 0 3-2 5-5 5z"/>',
};
...
function Icon({ name, ...rest }) {
  return React.createElement("svg", {
    ...
    dangerouslySetInnerHTML: { __html: ICON_PATHS[name] || "" }, ...rest,
  });
}
