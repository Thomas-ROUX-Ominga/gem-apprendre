...
export interface FichePourqui {
  label: string
  body: string
  stat?: { num: string; lbl: string }
}
...
export interface FicheData {
  ...
  pains?: string[]
  steps?: FicheSteps
  pricing?: FichePricing
  pourquoi?: FichePourquoi
  pourqui?: FichePourqui
  faq?: FicheFaq[]
  ctaTitle: string
  ctaBody: string
  ctaPrimary: string
...
export const FICHES: Record<string, FicheData> = {
  orientation: {
    family: 'orientation',
    univers: 'Je suis OÙ ?',
    uni: 'ou',
  ...
  bilan: {
    ...
    pricing: {
      label: "GEM'Choisir — la formule qui vous ressemble",
    ...
    pourquoi: {
      ...
      // TODO: remplacer par des témoignages validés par Cynthia
      testimonials: [
        { who: 'Marie-Laure, 41 ans', text: "Je pensais être bloquée dans mon poste pour toujours. Le bilan m'a aidée à nommer ce que je voulais vraiment — et j'ai négocié une évolution trois mois après." },
        { who: 'Thomas, 36 ans', text: "Cynthia a une façon de poser les questions qui fait avancer. Après 20 ans dans le même secteur, je suis enfin en reconversion vers ce qui me passionne." },
      ],
    },
    faq: [
      { q: 'Comment financer mon bilan de compétences ?', a: "Le bilan est éligible au CPF (Compte Personnel de Formation), à Pôle Emploi si vous êtes demandeur d'emploi, et aux OPCO pour les salariés. Après l'entretien de positionnement, on vous aide à monter le dossier de financement adapté à votre situation." },
      { q: 'Combien de temps dure réellement un bilan ?', a: "Selon la formule choisie, de 4 à 8 semaines en distanciel synchrone. Les séances se tiennent en visio à votre rythme, ce qui est compatible avec une activité professionnelle à temps plein." },
      { q: 'Peut-on faire un bilan en travaillant à temps plein ?', a: "Oui, c'est même le cas le plus fréquent. Toutes nos formules sont en distanciel et les rendez-vous sont planifiés selon vos disponibilités — soir et week-end inclus si nécessaire." },
      { q: "Quelle est la différence entre GEM’Essentiel et GEM’Confort ?", a: "La principale différence est le nombre d’heures d’entretien : 8 h pour GEM’Essentiel, 10 h pour GEM’Confort. Plus d’heures permettent d’aller plus loin dans l’exploration des pistes de reconversion et dans la construction du plan d’action." },
      { q: 'Le contenu de mon bilan est-il confidentiel ?', a: "Absolument. Votre bilan est couvert par le secret professionnel. Aucune information ne peut être communiquée à un employeur ou à un tiers sans votre accord explicite." },
    ],
  ...
  vae: {
    ...
    pourquoi: {
      ...
      testimonials: [
        { who: 'Sandrine, 44 ans, aide-soignante', text: "Je ne pensais pas avoir le niveau pour un diplôme. Cynthia m'a aidée à voir que 18 ans d'expérience, ça se démontre. J'ai obtenu mon BTS à 44 ans." },
        { who: 'Laurent, 38 ans, commercial', text: "La rédaction du Livret 2 m'intimidait. Avec l'accompagnement, chaque rendez-vous me rapprochait du but. Le jury a validé en totalité." },
      ],
    },
    faq: [
      { q: "Combien d'années d'expérience faut-il pour faire une VAE ?", a: "Il suffit d'au moins 1 an d'expérience (salariée, bénévole ou non salariée) en rapport avec la certification visée, quel que soit votre âge, votre statut ou votre niveau de formation initial." },
      { q: 'Combien de temps prend une VAE ?', a: "En moyenne 4 à 9 mois du premier entretien jusqu'au passage devant le jury. Le rythme dépend de votre disponibilité et de la complexité du dossier Livret 2." },
      { q: 'Peut-on financer la VAE ?', a: "Oui. La VAE est éligible au CPF, aux aides de Pôle Emploi, aux OPCO, et à certains fonds régionaux. L'entretien de découverte est offert — on voit ensuite ensemble les options de financement." },
      { q: 'Quelle certification choisir ?', a: "Lors de l'entretien de découverte, on analyse votre parcours et on identifie la certification RNCP la mieux adaptée à vos compétences réelles. C'est une étape clé : une bonne certification ciblée maximise vos chances de validation totale." },
      { q: "Que se passe-t-il si le jury ne valide qu'une partie ?", a: "C'est une validation partielle. Vous conservez les blocs de compétences acquis indéfiniment et pouvez compléter par une formation ou une nouvelle demande VAE. On vous accompagne dans cette démarche aussi." },
    ],
  ...
  entreprise: {
    ...
    ctaTitle: 'Prêt·e à donner vie à <em>votre projet</em> ?',
